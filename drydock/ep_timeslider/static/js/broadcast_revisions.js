 ...
 *
 */
function loadBroadcastRevisions() {  
  console.log ("loadBroadcastRevisions()");
  console.log (clientVars);
  console.log ("Number of revisions: " + clientVars.collab_client_vars.rev);
...
exports.loadBroadcastRevisions = loadBroadcastRevisions;
