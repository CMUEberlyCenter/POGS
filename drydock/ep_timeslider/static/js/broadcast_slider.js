 ...
 *
 */
function loadBroadcastSlider(fireWhenAllScriptsAreLoaded) {
  console.log ("loadBroadcastSlider()");

  var BroadcastSlider;

  // wrap this code in its own namespace
  (function(fireWhenAllScriptsAreLoaded) {
...
exports.loadBroadcastSlider = loadBroadcastSlider;
